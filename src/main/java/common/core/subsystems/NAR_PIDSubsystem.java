...
public abstract class NAR_PIDSubsystem extends SubsystemBase {
    ...
    public void initShuffleboard() {
        ...
        // NAR_Shuffleboard.addData(getName(), "UseOutput", controller::useOutput, 5, 0);
        ...
        NAR_Shuffleboard.addData(getName(), "Measurement Graph", controller::getMeasurement, 7, 2, 2, 2).withWidget(BuiltInWidgets.kGraph);
